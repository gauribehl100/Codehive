...
const ContactUs = () => {
  return (
    <div className='bg-purple-200 h-[145vh]'>
        <div className='mx-auto h-full flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-black lg:flex-row'>
        <div className='lg:w-[40%]'>
            <div className='flex flex-col gap-6 rounded-xl bg-richblack-800 p-4 lg:p-6'>
                <div className='flex flex-col gap-[2px] p-3 text-sm text-richblack-200'>
                    ...
                    <p className='font-semibold'>info@CODEHive.com</p>
                </div>
                <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    <div className='flex flex-row items-center gap-3'>
                    ...
                    <p className='font-semibold'>Kirti Nagar 1st Block 1st Cross, Rammurthy nagar, Bangalore-560016</p>
                </div>
                <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    <div className='flex flex-row items-center gap-3'>
        ...
        <div className='lg:w-[60%]'>
            <div className='border border-black  text-richblack-300 rounded-xl mt-10 lg:p-14 flex gap-3 flex-col'>
